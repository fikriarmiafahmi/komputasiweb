...
<body>
    <div>
        ...
        <p>-Command SQL bisa melalui 2 cara, yaitu metode POS lewat <b>inputan.php</b> dan metode GET dari file <b>perintah.php</b></p>
        <p>-Settingan URL untuk perintah SQL di file <b>perintah.php</b> yaitu tambahkan berikut:</p>
    ...
    <div class="container d-flex mt-5 w-100">
        ...
        <form class="d-flex flex-column flex-fill mx-4" action="./perintah.php" method="get">
            ...
            <input type="text" name="nama" placeholder="where nama (var)" class="mb-3" >
            <input type="text" name="nim" placeholder="where nim (var)" class="mb-3" >
            <input type="text" name="angkatan" placeholder="where angkatan (int)" class="mb-3" >
            <button type="submit" class="btn btn-danger">Delete</button>
        </form>
        
        <form class="d-flex flex-column flex-fill mx-4" action="./perintah.php" method="get">
            <input type="hidden" name="update" value="true">
            <input type="text" name="id" placeholder="set id (int)" class="mb-3" >
            <input type="text" name="nama" placeholder="set nama (var)" class="mb-3" >
            <input type="text" name="nim" placeholder="set nim (var)" class="mb-3" >
            <input type="text" name="angkatan" placeholder="set angkatan (int)" class="mb-3" ><br>
